...
class PagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "dashboard renders sankey chart with subcategories" do
    ...
    parent_category = @family.categories.create!(name: "Shopping", color: "#FF5733", user: @user)
    subcategory = @family.categories.create!(name: "Groceries", parent: parent_category, color: "#33FF57", user: @user)

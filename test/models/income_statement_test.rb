...
class IncomeStatementTest < ActiveSupport::TestCase
  ...
  setup do
    ...
    @income_category = @family.categories.create! name: "Income", user: users(:empty)
    @food_category = @family.categories.create! name: "Food", user: users(:empty)
    @groceries_category = @family.categories.create! name: "Groceries", parent: @food_category, user: users(:empty)
  ...
  test "calculates category-specific median expense" do
    ...
    other_food_category = @family.categories.create! name: "Restaurants", parent: @food_category, user: users(:empty)

class Settings::HostingsController < ApplicationController
  ...
  def update
    ...
    if hosting_params.key?(:chancen_student_sheet_url)
      Setting.chancen_student_sheet_url = hosting_params[:chancen_student_sheet_url].presence
    end
  ...
  private
    def hosting_params
      ...
      params.require(:setting).permit(:onboarding_state, :require_email_confirmation, :invite_only_default_family_id, :chancen_student_sheet_url, :brand_fetch_client_id, :brand_fetch_high_res_logos, :twelve_data_api_key, :tiingo_api_key, :eodhd_api_key, :alpha_vantage_api_key, :openai_access_token, :openai_uri_base, :openai_model, :openai_json_mode, :llm_context_window, :llm_max_response_tokens, :llm_max_items_per_call, :exchange_rate_provider, :securities_provider, :syncs_include_pending, :auto_sync_enabled, :auto_sync_time, :external_assistant_url, :external_assistant_token, :external_assistant_agent_id, securities_providers: [])
    end

  ...
  private
    ...
    def require_ai_enabled
      unless current_resource_owner&.ai_enabled?
        render_json({ error: "feature_disabled", message: "AI features are not enabled for this user", ai_available: current_resource_owner.ai_available? }, status: :forbidden)
      end
    end
end
